...
class intersection_iterable_impl : public iterable_impl_interface<typename Traits::iterable_base_traits>
{
public:
    intersection_iterable(const Iterable& i_iterable, const Iterables& ... i_iterables);
