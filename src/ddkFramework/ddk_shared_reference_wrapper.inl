...
shared_reference_wrapper_impl<T,ReferenceCounter>::shared_reference_wrapper_impl(T* i_data,const tagged_pointer<ReferenceCounter>& i_refCounter)
: shared_pointer_wrapper_impl<T,ReferenceCounter>(i_data,i_refCounter)
{
