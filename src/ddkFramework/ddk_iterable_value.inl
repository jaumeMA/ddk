...
: iterable_value<detail::forward_iterable_traits<T>>(*other.m_value,other.m_resolver,other.m_iterableInterface)
{
}
template<typename T>
template<typename TT>
...
: iterable_value<detail::bidirectional_iterable_traits<T>>(*other.m_value,other.m_resolver,other.m_iterableInterface)
{
}
template<typename T>
template<typename TT>
...
: iterable_value<detail::random_access_iterable_traits<T>>(*other.m_value,other.m_resolver,other.m_iterableInterface)
{
}
template<typename T>
template<typename TT>
