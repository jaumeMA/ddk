...
REQUIRED(IS_CONSTRUCTIBLE(type_by_index<IIndex1>,Arg1),IS_CONSTRUCTIBLE(type_by_index<IIndex2>,Arg2),IS_CONSTRUCTIBLE(type_by_index<IIndexs>,Args)...)
...
{
	return get<type_by_index<IIndex>>(m_storage.template at<IIndex>());
}
template<size_t Index1, size_t Index2, size_t ... Indexs, typename Type1, typename Type2, typename ... Types>
template<size_t IIndex>
...
{
	return extract<type_by_index<IIndex>>(m_storage.template at<IIndex>());
}
template<size_t Index1, size_t Index2, size_t ... Indexs, typename Type1, typename Type2, typename ... Types>
...
{
	assign<type_by_index<IIndex>>(m_storage.template at<IIndex>(), std::forward<Arg>(i_arg));
