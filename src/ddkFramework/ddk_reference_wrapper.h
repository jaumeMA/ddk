...
template<typename T>
inline shared_reference_wrapper_impl<T,shared_reference_counter> __make_shared_reference(T* i_data,const tagged_pointer<shared_reference_counter>& i_refCounter,const IReferenceWrapperDeleter* i_refDeleter);
template<typename T>
inline shared_reference_wrapper_impl<T,distributed_reference_counter> __make_shared_reference(T* i_data,const tagged_pointer<distributed_reference_counter>& i_refCounter,const IReferenceWrapperDeleter* i_refDeleter);
template<typename T>
...
template<typename T>
inline unique_reference_wrapper<T> as_unique_reference(T* i_ptr, const IReferenceWrapperDeleter& i_refDeleter);

template<typename T>
inline unique_reference_wrapper<T> as_unique_reference(T* i_ptr);

template<typename T>
inline unique_reference_wrapper<T> as_unique_reference(T* i_ptr, const tagged_pointer<unique_reference_counter>& i_refCounter, const IReferenceWrapperDeleter* i_refDeleter = nullptr);
...
template<typename T>
inline shared_reference_wrapper<T> as_shared_reference(T* i_ptr, const IReferenceWrapperDeleter* i_refDeleter);
template<typename T>
inline shared_reference_wrapper<T> as_shared_reference(T* i_ptr,const tagged_pointer<shared_reference_counter>& i_refCounter,const IReferenceWrapperDeleter* i_refDeleter = nullptr);
...
template<typename T>
inline distributed_reference_wrapper<T> as_distributed_reference(T* i_ptr, const tagged_pointer<distributed_reference_counter>& i_refCounter, const IReferenceWrapperDeleter* i_refDeleter = nullptr);
...
template<typename T>
inline atomic_shared_reference_wrapper<T> as_atomic_shared_reference(T* i_ptr,const IReferenceWrapperDeleter* i_refDeleter);
template<typename T>
inline atomic_distributed_reference_wrapper<T> as_atomic_shared_reference(T* i_ptr,const tagged_pointer<shared_reference_counter>& i_refCounter,const IReferenceWrapperDeleter* i_refDeleter = nullptr);

template<typename T>
inline atomic_distributed_reference_wrapper<T> as_atomic_distributed_reference(T* i_ptr);
template<typename T>
inline atomic_distributed_reference_wrapper<T> as_atomic_distributed_reference(T* i_ptr,const IReferenceWrapperDeleter* i_refDeleter);
template<typename T>
inline atomic_distributed_reference_wrapper<T> as_atomic_shared_reference(T* i_ptr,const tagged_pointer<distributed_reference_counter>& i_refCounter,const IReferenceWrapperDeleter* i_refDeleter = nullptr);
