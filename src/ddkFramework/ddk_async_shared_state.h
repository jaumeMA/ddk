...
template<typename T>
using private_async_state_dist_ref = distributed_reference_wrapper<private_async_state<T>>;
template<typename T>
using private_async_state_const_dist_ref = distributed_reference_wrapper<const private_async_state<T>>;
template<typename T>
using private_async_state_dist_ptr = distributed_pointer_wrapper<private_async_state<T>>;
template<typename T>
using private_async_state_const_dist_ptr = distributed_pointer_wrapper<const private_async_state<T>>;
