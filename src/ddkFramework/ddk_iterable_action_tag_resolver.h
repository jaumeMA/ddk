...
template<typename ... T>
mpl::type_pack<begin_action_tag,end_action_tag,forward_action_tag,backward_action_tag,displace_action_tag,remove_action_tag,mpl::template_class_holder<add_action_tag>,mpl::template_class_holder<agnostic_sink_action_tag>,size_action_tag> supported_actions(T...);
