...
constexpr auto union_iterable_adaptor<Iterables...>::perform_action(ActionTag&& i_actionTag)
{
...
constexpr auto union_iterable_adaptor<Iterables...>::perform_action(ActionTag&& i_actionTag) const
{
    typedef typename mpl::make_sequence<0,s_numTypes>::type seq_type;
...
constexpr auto union_iterable_adaptor<Iterables...>::perform_action(const mpl::sequence<Indexs...>&,ActionTag&& i_actionTag)
{
...
template<typename ... Iterables>
template<size_t ... Indexs,typename ActionTag>
constexpr auto union_iterable_adaptor<Iterables...>::perform_action(const mpl::sequence<Indexs...>&,ActionTag&& i_actionTag) const
{
...
constexpr iterable_action_tag_result<Traits,ActionTag> union_iterable_adaptor<Iterables...>::_perform_action(deduced_adaptors& i_adaptors,ActionTag&& i_actionTag)
{
    return i_adaptors.template get<Index>().perform_action(std::forward<ActionTag>(i_actionTag));
}
template<typename ... Iterables>
template<size_t Index,typename Traits,typename ActionTag>
constexpr iterable_action_tag_result<const_iterable_traits<Traits>,ActionTag> union_iterable_adaptor<Iterables...>::_const_perform_action(const deduced_adaptors& i_adaptors,ActionTag&& i_actionTag)
{
    return i_adaptors.template get<Index>().perform_action(std::forward<ActionTag>(i_actionTag));
}
...
TEMPLATE(typename ActionTag)
REQUIRED(ACTION_TAGS_SUPPORTED(traits,ActionTag))
constexpr auto iterable_adaptor<detail::union_iterable_impl<Iterables...>>::perform_action(ActionTag&& i_actionTag)
{
...
TEMPLATE(typename ActionTag)
REQUIRED(ACTION_TAGS_SUPPORTED(const_traits,ActionTag))
constexpr auto iterable_adaptor<detail::union_iterable_impl<Iterables...>>::perform_action(ActionTag&& i_actionTag) const
{
    if (auto actionRes = perform_action(union_iterable_action{ std::forward<ActionTag>(i_actionTag) }))
    {
...
template<typename ... Iterables>
template<typename ActionTag>
constexpr auto iterable_adaptor<detail::union_iterable_impl<Iterables...>>::perform_action(union_iterable_action<ActionTag> i_actionTag)
{
...
template<typename ... Iterables>
template<typename ActionTag>
constexpr auto iterable_adaptor<detail::union_iterable_impl<Iterables...>>::perform_action(union_iterable_action<ActionTag> i_actionTag) const
{
    typedef iterable_adaptor<detail::union_iterable_impl<Iterables...>> adaptor_t;
...
TEMPLATE(typename ActionTag)
REQUIRED(ACTION_TAGS_SUPPORTED(const_traits,ActionTag))
constexpr auto iterable_adaptor<const detail::union_iterable_impl<Iterables...>>::perform_action(ActionTag&& i_actionTag) const
{
    if (auto actionRes = perform_action(union_iterable_action{ std::forward<ActionTag>(i_actionTag) }))
    {
        return make_result<iterable_action_tag_result<traits,ActionTag>>(actionRes);
...
template<typename ... Iterables>
template<typename ActionTag>
constexpr auto iterable_adaptor<const detail::union_iterable_impl<Iterables...>>::perform_action(union_iterable_action<ActionTag> i_actionTag) const
{
    typedef iterable_adaptor<detail::union_iterable_impl<Iterables...>> adaptor_t;
    typedef union_iterable_action_result<adaptor_t,ActionTag> union_action_result;
