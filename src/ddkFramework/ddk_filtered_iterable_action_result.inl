...
template<typename Traits,typename ActionTag,typename Filter>
filtered_iterable_action_error<Traits,ActionTag,Filter>::filtered_iterable_action_error(iterable_action_tag_error<Traits,ActionTag>&& i_error,const Filter& i_filter,bool i_filteredOut)
...
template<typename Traits,typename ActionTag,typename Filter>
template<typename AActionTag>
filtered_iterable_action_error<Traits,ActionTag,Filter>::filtered_iterable_action_error(filtered_iterable_action_error<Traits,AActionTag,Filter>&& i_error)
...
template<typename Traits,typename ActionTag,typename Filter>
template<typename TTraits>
filtered_iterable_action_error<Traits,ActionTag,Filter>::operator iterable_action_tag_error<TTraits,ActionTag>() &&
{
    typedef iterable_action_recovery_tag<TTraits,ActionTag> action_recovery_tag;
