...
private:
	...
	ddk::function<reference()> m_callable;
	...
	ddk::unique_pointer_wrapper<detail::await_executor<T>> m_executor;
};
...
private:
	...
	mutable arena<mpl::size_of_qualified_type<reference>::value,alignof(reference)> m_iteratorValueContainer;
};
