...
#ifndef LIBLOG4CXX_DEPRECATED_HH
# define LIBLOG4CXX_DEPRECATED_HH
...
//  void foo () LIBLOG4CXX_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar LIBLOG4CXX_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a LIBLOG4CXX_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define LIBLOG4CXX_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define LIBLOG4CXX_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define LIBLOG4CXX_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! LIBLOG4CXX_DEPRECATED_HH
